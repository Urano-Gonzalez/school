  ...
  <div class="col-xl-6">
    ...
    <div class="card shadow mb-4">
      ...
      <a href="#admin_panel" class="d-block card-header py-3" data-toggle="collapse"
          ...
          <h6 class="m-0 font-weight-bold text-primary">Asistencia de alumnos</h6>
      </a>
      ...
      <div class="collapse show" id="admin_panel">
          <div class="card-body">
            <form id="reiniciar_sistema_form" method="post">
              ...
              <button class="btn btn-success" type="submit"><i class="fas fa-database fa-fw"></i> Pasar asistencia</button>
            </form>
